...
// //Варіант 1 - темплейт стрінга:
// for (let i = 0; i < 10; i++) {
//     document.write(`<div>Довільний текст ${i}</div>`)
//
// }
// //Варіант 2 - конкатинація:
// for (let i = 0; i < 10; i++) {
//     document.write('<div> Довільний текст ' + i + ' </div>')
//
// }
...
// let i2 = 0;
// while (i2 < 20) {
//     document.write(`<div>Довільний текст ${i2}</div>`);
//     i2++;
// }
// //
// //
...
document.write(`<div>`)
    document.write(`<ul>`)
        for (const listOfItem of listOfItems) {document.write(`<li>${listOfItem}</li>`)
            }
    document.write(`</ul>`)
document.write(`</div>`)
