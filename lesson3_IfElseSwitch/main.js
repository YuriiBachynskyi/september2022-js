...
// ||-Логічний оператор OR:Якщо у лівій частині від логічного оператора відпрацює True то ми отримаємо це значення . Якщо у лівій части
// спрацбє False то те що було у лівій частині не спрацьовує і відпрацьовує права частина від OR а саме те що там описано
